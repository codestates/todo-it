    ...
    <UserInfoSettingPageContainer>
      <Body>
        <StyledDiv>
          ...
          <InputBox>
            <ValueInput type="text" placeholder="user.name" value={name} onChange={NameHandler}/>
            <Warning style={isName ? {display: "none"} : {}}>닉네임은 4~14글자 입니다.</Warning>
          </InputBox>
        </StyledDiv>
        <StyledDiv>
          <KeyInput>이메일 :</KeyInput>
          <KeyInput style={{textAlign:"center", paddingLeft: "0", paddingRight:"160px"}}>user.email</KeyInput>
        </StyledDiv>
        <StyledDiv>
